...
<div class="flex items-center justify-center">
	<div
		class="w-full max-w-sm space-y-6 rounded-xl bg-white p-6 shadow-xl sm:p-8 dark:bg-neutral-900"
	>
		<!-- Header -->
		<div>
			<h2
		...
		<div class="space-y-3 pt-4">
			<p class="text-center text-sm font-medium text-gray-600 dark:text-neutral-400">
		...
		<form class="space-y-4" onsubmit={handleEmailSignUp}>
				...
				<div class="ml-3 text-sm leading-6">
					<label for="terms-conditions" class="text-gray-700 dark:text-neutral-300">
						I agree to the <a
							...
							class="font-medium text-orange-600 hover:underline dark:text-orange-400">Terms</a
						>
						and
						<a
							href="/privacy"
			...
			{#if feedbackMessage && submittingProvider === 'email'}
				<!-- Only show email feedback here -->
				<div
			...
			{/if}
			{#if feedbackMessage && submittingProvider !== 'email' && submittingProvider !== null}
				<!-- Show social feedback maybe above buttons? Or rely on alerts -->

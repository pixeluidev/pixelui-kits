<div
	class="relative mx-auto h-[600px] w-[300px] rounded-[2.5rem] border-[14px] border-gray-800 bg-gray-800 shadow-xl dark:border-gray-800"
>
	<div
		class="absolute top-0 left-1/2 h-[18px] w-[148px] -translate-x-1/2 rounded-b-[1rem] bg-gray-800"
	></div>

<div class="w-full max-w-sm overflow-hidden rounded-lg bg-white shadow-lg dark:bg-gray-800">
	...
	<div class="flex items-center bg-gray-900 px-6 py-3 pl-24 relative">
		...
		<h1 class="mx-3 text-lg font-semibold text-white">Budi Bin Fulan</h1>
	</div>

	<div class="px-6 py-4 text-sm">
		<h1 class=" font-semibold text-gray-800 dark:text-white">Senior Frontend Engineer</h1>

		<p class="py-2 text-gray-700 dark:text-gray-400">
			Full Stack maker & UI / UX Designer , love hip hop music Author of Building UI.
		</p>

		<div class="mt-4 flex items-center text-gray-700 dark:text-gray-200">
			<svg
			...
			<h1 class="px-2 text-sm">Pixel UI</h1>
		</div>
		...
		<div class="mt-4 flex items-center text-gray-700 dark:text-gray-200">
			...
			<h1 class="px-2 text-sm">Indonesia</h1>
		</div>
		...
		<div class="mt-4 flex items-center text-gray-700 dark:text-gray-200">
			...
			<h1 class="px-2 text-sm">fulan@example.com</h1>
		</div>
	</div>
</div>

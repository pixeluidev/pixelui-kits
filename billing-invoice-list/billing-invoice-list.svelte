...
<section class="mx-auto w-full max-w-3xl px-4 py-10 sm:px-6 lg:px-8">
	<div class="rounded-xl bg-white p-5 shadow-sm sm:p-6 dark:bg-neutral-800/50">
		...
		>
			...
			<button
				type="button"
				class="flex w-full shrink-0 items-center justify-center gap-1.5 rounded-lg border border-primary px-4 py-2 text-sm font-medium text-primary transition-colors hover:bg-primary/10 focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:outline-none active:opacity-85 sm:w-auto dark:border-orange-400 dark:text-orange-400 dark:hover:bg-orange-400/10 dark:focus:ring-primary dark:focus:ring-offset-neutral-800"

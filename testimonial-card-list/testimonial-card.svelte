...
>
	...
	>
		<a
			class="hover:text-primary flex items-center gap-1.5 text-xs font-medium text-gray-500 transition-colors duration-150 dark:text-neutral-400 dark:hover:text-orange-400"

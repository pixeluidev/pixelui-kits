		...
		>
			...
			>
				...
				{:else}
					...
					<span
						class={`me-2 flex h-5 w-5 items-center justify-center rounded-full border-2 sm:me-2.5 ${isCurrent ? 'border-primary bg-primary dark:border-orange-400 dark:bg-orange-400' : 'border-gray-400 dark:border-neutral-600'} shrink-0`}
					>
						{#if !isCurrent}

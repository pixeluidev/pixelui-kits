...
<div class="space-y-6" transition:fade>
	...
	<div class="mt-4 flex items-start gap-3">
		<div class="flex h-5 items-center">
			<input
				class="dark:focus:ring-primary h-4 w-4 rounded border border-gray-300 bg-gray-50 focus:ring-3 focus:ring-orange-300 dark:border-neutral-600 dark:bg-neutral-700 dark:ring-offset-neutral-800"
		...
		<label class="text-sm font-medium text-gray-700 dark:text-neutral-300" for="installment-terms"
			>I accept the <a class="text-primary hover:underline dark:text-orange-400" href="/components"

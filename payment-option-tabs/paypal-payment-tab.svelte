...
<div class="flex min-h-[10rem] flex-col items-center justify-center p-6" transition:fade>
	<p class="mb-6 text-center text-gray-600 dark:text-neutral-400">
		Proceed with PayPal to complete your payment securely.
	</p>
	<button

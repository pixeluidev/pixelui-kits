...
<script lang="ts">
	...
	const imageUrl: string = "https://images.unsplash.com/photo-1556155092-490a1ba16284?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1770&q=80";
	const imageAlt: string = 'Person receiving a notification on their phone';
	const headline: string = "Be the First to Know!";
	const description: string = "Join our waitlist and get exclusive early access to Pixel UI Pro features, plus a special launch discount.";
...
<section class="relative bg-white dark:bg-neutral-900 overflow-hidden">
	<div class="mx-auto max-w-7xl lg:grid lg:grid-cols-12 lg:gap-x-8 lg:px-8">
		...
		<div class="px-6 pb-24 pt-10 sm:pb-32 lg:col-span-7 lg:px-0 lg:pb-56 lg:pt-48 xl:col-span-6">
			<div class="mx-auto max-w-2xl lg:mx-0">
				...
				<h1 class="mt-4 text-4xl font-bold tracking-tight text-gray-900 dark:text-white sm:mt-6 sm:text-5xl lg:text-6xl">
					{headline}
				</h1>
                ...
                <p class="mt-6 text-xs leading-5 text-gray-500 dark:text-neutral-400">
                    {privacyPolicyText}
                    <a href={privacyPolicyHref} class="font-medium text-gray-700 hover:text-orange-600 dark:text-neutral-300 dark:hover:text-orange-400">Privacy Policy</a>.
                </p>
			</div>
		</div>
		...
		<div class="relative lg:col-span-5 lg:-mr-8 xl:absolute xl:inset-0 xl:left-1/2 xl:mr-0">
			<div class="aspect-[3/2] w-full bg-gray-50 dark:bg-neutral-800 lg:absolute lg:inset-0 lg:aspect-auto lg:h-full">
                <img

	...
	<div class="w-full max-w-md space-y-8 rounded-lg bg-white p-8 shadow-lg dark:bg-neutral-800">
			...
			<div class="-space-y-px rounded-md shadow-sm">
				...
				<div>
					...
					<input
						...
						bind:value={email}
						oninput={clearError}
						class="relative block w-full rounded-t-md border-0 px-3 py-2.5 text-gray-900 ring-1 ring-gray-300 ring-inset placeholder:text-gray-400 focus:z-10 focus:ring-2 focus:ring-orange-500 focus:ring-inset sm:text-sm sm:leading-6 dark:bg-neutral-700 dark:text-white dark:ring-neutral-600 dark:placeholder:text-neutral-400 dark:focus:ring-orange-400"
				...
				<div class="relative">
					...
					<input
						...
						bind:value={password}
						oninput={clearError}
						class="relative block w-full rounded-b-md border-0 px-3 py-2.5 pr-10 text-gray-900 ring-1 ring-gray-300 ring-inset placeholder:text-gray-400 focus:z-10 focus:ring-2 focus:ring-orange-500 focus:ring-inset sm:text-sm sm:leading-6 dark:bg-neutral-700 dark:text-white dark:ring-neutral-600 dark:placeholder:text-neutral-400 dark:focus:ring-orange-400"
		...
		<div class="relative my-8">
			...
			<div class="relative flex justify-center text-sm">
				<span class="bg-white px-2 text-gray-500 dark:bg-neutral-800 dark:text-neutral-400"
		...
		<div class="mt-6 grid grid-cols-3 gap-3">
			<div>
				<button
					...
					disabled={formState === 'submitting'}
					class="inline-flex w-full justify-center rounded-md bg-white px-4 py-2 text-gray-500 shadow-sm ring-1 ring-gray-300 transition-colors ring-inset hover:bg-gray-50 focus:outline-offset-0 disabled:cursor-not-allowed disabled:opacity-70 dark:bg-neutral-700 dark:text-neutral-300 dark:ring-neutral-600 dark:hover:bg-neutral-600"
			...
			<div>
				...
				>
					<Twitter class="h-5 w-5 text-[#1DA1F2]" />
					<!-- Twitter color -->
				</button>
			</div>
			<div>

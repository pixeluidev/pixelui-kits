...
<section class="relative h-screen w-full overflow-hidden">
	...
	<div class="relative z-10 flex h-full items-center justify-center px-6 py-24 text-center sm:py-32 lg:px-8">
		<div class="max-w-2xl">
			...
			<div class="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row sm:gap-6">
				...
				<a
					...
					class="group inline-flex w-full items-center justify-center gap-1.5 rounded-md border border-white/40 bg-white/5 px-5 py-[11px] text-base font-semibold leading-6 text-white backdrop-blur-sm transition-colors hover:border-white/70 hover:bg-white/10 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white sm:w-auto"
				> <!-- Gaya sekunder sedikit berbeda untuk kontras di video -->
					<span>{secondaryCtaText}</span>
                    <ChevronRight class="h-5 w-5 transition-transform group-hover:translate-x-1" aria-hidden="true"/>
				</a>
			</div>
		</div>
	</div>

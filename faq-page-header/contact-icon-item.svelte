<script lang="ts">
	import type { ContactIconInfo } from './data';

	export let contact: ContactIconInfo;

	// Determine the tag based on whether href exists
...
>
	...
	>
		<svelte:component class="h-5 w-5" strokeWidth={2} this={contact.icon} />
	</div>
	<div>

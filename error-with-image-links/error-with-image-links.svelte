<section class=" ">
	<div class="container min-h-screen px-6 py-12 mx-auto lg:flex lg:items-center lg:gap-12 max-w-6xl">
		...
		<div class="relative w-full mt-8 lg:w-1/2 lg:mt-0">
			<img class=" w-full lg:h-[32rem] h-80 md:h-96 rounded-lg object-cover " src="/components-images/kaset-kusut.png" alt="">
		</div>
	</div>
</section>
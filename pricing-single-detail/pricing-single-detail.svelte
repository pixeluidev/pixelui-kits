		...
		>
			<div class="p-8 sm:p-10 lg:flex-auto">
				...
				<div class="mt-10 flex items-center gap-x-4">
					<h4 class="flex-none text-sm leading-6 font-semibold text-indigo-600">What’s included</h4>
			...
			<div class="-mt-2 p-2 lg:mt-0 lg:w-full lg:max-w-md lg:flex-shrink-0">
				<div
					class="rounded-2xl bg-gray-50 py-10 text-center ring-1 ring-gray-900/5 ring-inset lg:flex lg:flex-col lg:justify-center lg:py-16"
				>
					<div class="mx-auto max-w-xs px-8">
						...
						<p class="mt-6 flex items-baseline justify-center gap-x-2">
							...
							<span class="text-sm leading-6 font-semibold tracking-wide text-gray-600">USD</span>
						</p>
						<a
							...
							href="/category/cards">Get access</a
						>

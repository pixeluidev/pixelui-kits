...
<div class="flex  items-center justify-center  px-4 py-12">
	<div class="w-full max-w-sm space-y-6 rounded-lg bg-white p-6 shadow-xl dark:bg-neutral-900 sm:p-8">
		<!-- Header -->
		<div>
        ...
        <div class="space-y-3 pt-2">
            ...
            >
                {#if submittingProvider === 'twitter'}
                     ...
                     <span>Processing...</span>
                {:else}
                    <TwitterIcon class="h-5 w-5 text-[#1DA1F2]" /> <!-- Use specific icon -->
        ...
        <div class="relative my-6">
            ...
            <div class="relative flex justify-center text-sm">
                <span class="bg-white px-2 text-gray-500 dark:bg-neutral-900 dark:text-neutral-400">Or sign in with email</span>
            </div>
        </div>
		...
		<form class="space-y-4" onsubmit={handleEmailLogin}>
            ...
            <div>
                ...
                <div class="mt-1">
                    <input
                        ...
                        bind:value={email} oninput={clearError}
                        disabled={isSubmittingAny}
            ...
            <div>
                 <div class="flex items-center justify-between">
                    ...
                    <div class="text-sm">
                        <a href="/forgot-password" class="font-medium text-orange-600 hover:text-orange-500 dark:text-orange-400 dark:hover:text-orange-300">
                            Forgot password?
                        </a>
                    </div>
                </div>
                <div class="mt-1 relative">
                    <input
                        ...
                        bind:value={password} oninput={clearError}
                        disabled={isSubmittingAny}
                        aria-invalid={formState === 'error' && errorMessage.toLowerCase().includes('password')}
                    ...
                    >
                        {#if showPassword} <EyeOff class="h-5 w-5" aria-hidden="true" />
                        {:else} <Eye class="h-5 w-5" aria-hidden="true" /> {/if}
                    </button>
                </div>
            </div>

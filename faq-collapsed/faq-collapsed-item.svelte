...
<div class="transition-colors duration-200 ease-in-out">
	...
	>
		...
		{#if isOpen}
			<Minus class="h-6 w-6 flex-shrink-0 text-orange-500" strokeWidth={2.5} />
		{:else}
			<Plus class="h-6 w-6 flex-shrink-0 text-orange-500" strokeWidth={2.5} />
		{/if}
	...
	{#if isOpen}
		...
		>
			...
			<div class="border-l-2 border-orange-400 pl-4 dark:border-orange-600">

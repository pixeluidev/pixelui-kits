...
<div class="container mx-auto ml-auto flex items-center justify-center px-6 py-12">
	<div class="w-full">
		<div class="mx-auto flex max-w-lg flex-col items-center text-center">
			...
			<h1 class="mt-3 text-2xl font-semibold text-gray-800 md:text-3xl dark:text-white">
				{page.error?.message ?? 'We lost this page'}
			</h1>
		...
		<div class="mx-auto mt-8 grid w-full max-w-6xl grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
